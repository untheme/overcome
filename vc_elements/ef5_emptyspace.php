...
vc_map(array(
    ...
    'description' => esc_html__('Blank space with custom height for each screen size', 'overcome'),
    'params' => array(
        array(
            'type'       => 'param_group',
            'heading'    => esc_html__( 'Add Custom Screen Size', 'overcome' ),
            'description' => esc_html__('Enter your screen size, ex: 1920px (Note: CSS measurement units allowed).','overcome'),
            'param_name' => 'values',
            ...
            'params' => array(
                array(
                    'type'             => 'textfield',
                    'heading'          => esc_html__( 'Min Screen Size', 'overcome' ),
                ...
                array(
                    'type'             => 'textfield',
                    'heading'          => esc_html__( 'Max Screen Size', 'overcome' ),
                    'description'      => esc_html__( 'Default: 4800px', 'overcome' ),
                    'edit_field_class' => 'vc_col-sm-6',
                ...
                array(
                    'type'        => 'textfield',
                    'heading'     => esc_html__( 'Empty space height', 'overcome' ),
                    'param_name'  => 'height',
                    'description' => esc_html__('Enter empty space height (Note: CSS measurement units allowed).','overcome'),
                ),
            ),
        ),
        array(
