...
vc_map(array(
    ...
    'description' => esc_html__('Add a HTML5 Videos', 'overcome'),
    'params'      => array(
        array(
            'type'       => 'img',
        ...
        array(
            ...
            'param_name'  => 'el_class',
            'description' => esc_html__( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'overcome' ),
        ),
        array(
            'type'       => 'el_id',
        ...
        array(
            'type'       => 'textfield',
            'heading'    => esc_html__('Small Heading','overcome'),
        ...
        array(
            'type'       => 'textarea',
            'heading'    => esc_html__('Heading Part','overcome'),
        ...
        array(
            'type'       => 'textarea',
            'heading'    => esc_html__('Content','overcome'),
            'param_name' => 'content',
            'group'       => esc_html__('Content','overcome')
        ),
        // Link
        array(
            ...
            'description'=> esc_html__('Add a link to another page!','overcome'),
            'param_name' => 'btn_link',
            'group'       => esc_html__('Content','overcome')
        ),
        array(
            'type'       => 'img',
            'heading'    => esc_html__('Play Button','overcome'),
            'param_name' => 'play_btn',
            'value'      =>  array(
        ...
        array(
            'type'       => 'dropdown',
            'heading'    => esc_html__('Play Effect','overcome'),
        ...
        array(
            'type'       => 'textfield',
            'heading'    => esc_html__('Play Button Text','overcome'),
        ...
        array(
            ...
            'heading'    => esc_html__('Custom Play Button','overcome'),
            'value'      => '',
            'description'      =>esc_html__( 'Upload your play button','overcome'),
            'dependency' => array(
                'element' => 'play_btn',
                'value'   => array('custom'),
            ),
        ...
        array(
            'type'       => 'dropdown',
            'heading'    => esc_html__('Video Type','overcome'),
            'param_name' => 'video_type',
            'value'      => array(
                esc_html__('Default','overcome')   => '1',
                esc_html__('Popup','overcome')     => '2',
            ),
            'std'         => '2',
            'group'       =>esc_html__( 'Video','overcome'),
            'admin_label' => true,
        ...
        array(
            'type'       => 'dropdown',
            'heading'    => esc_html__('Video Source','overcome'),
            'param_name' => 'video_source',
            'value'      =>   array(
                esc_html__('Online Video','overcome')   => '1',
                esc_html__('Uploaded Video','overcome') => '2',
                esc_html__('Hosted Video','overcome')   => '3', 
                esc_html__('Embed code','overcome')     => '4', 
            ),
            'std'         => '1',
            'group'       =>esc_html__( 'Video','overcome'),
            'admin_label' => true,
        ...
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Online Video','overcome'),
            'description' => sprintf( __( 'Enter link to video, EX: //www.youtube.com/watch?v=vI9AxTCSrOU (Note: read more about available formats at WordPress <a href="%s" target="_blank">codex page</a>).', 'overcome' ), '//codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F' ),
        ...
        array(
            'type'        => 'ef5_video',
            'heading'     => esc_html__('Uploaded Video','overcome'),
            'description' => esc_html__('choose your uploaded video','overcome' ),
        ...
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('MP4','overcome'),
            'description' => esc_html__('Enter your MP4 video file url, ex: //dev.joomexp.com/libs/videos/video-01.mp4','overcome'),
        ...
        array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('OGV','overcome'),
            'description' => esc_html__('Enter your OGV video file url, ex: //dev.joomexp.com/libs/videos/video-03.ogv','overcome'),
        ...
        array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('OGG','overcome'),
            'description' => esc_html__('Enter your OGV video file url, ex: //dev.joomexp.com/libs/videos/video-03.ogg','overcome'),
        ...
        array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('WEBM','overcome'),
            'description' => esc_html__('Enter your WEBM video file url, ex: //dev.joomexp.com/libs/videos/video-03.webm','overcome'),
        ...
        array(
            ...
            'class'       => '',
            'heading'     => esc_html__('Embed video','overcome'),
            'description' => esc_html__('Enter your embed code.','overcome'),
        ...
        array(
            'type'       => 'checkbox',
            'class'      => '',
            'heading'    => esc_html__( 'Loop','overcome'),
            'param_name' => 'loop',
            'std'        => 'false',
            'group'      => esc_html__( 'Video','overcome'),
            'dependency' => array(
        ...
        array(
            'type'       => 'checkbox',
            'class'      => '',
            'heading'    => esc_html__( 'Autoplay','overcome'),
            'param_name' => 'autoplay',
            'std'        => 'false',
            'group'      => esc_html__( 'Video','overcome'),
            'dependency' => array(
        ...
        array(
            'type'       => 'checkbox',
            'class'      => '',
            'heading'    => esc_html__( 'Muted','overcome'),
            'param_name' => 'muted',
            'std'        => 'false',
            'group'      => esc_html__( 'Video','overcome'),
            'dependency' => array(
        ...
        array(
            'type'       => 'checkbox',
            'class'      => '',
            'heading'    => esc_html__( 'Controls','overcome'),
            'param_name' => 'controls',
            'std'        => 'false',
            'group'      =>esc_html__( 'Video','overcome'),
            'dependency' => array(
        ...
        array(
            'type'       => 'checkbox',
            'heading'    => esc_html__( 'Show Button Play','overcome'),
            'param_name' => 'show_btn',
            'std'        => 'true',
            'dependency' => array(
                'element'            => 'autoplay',
        ...
        array(
            'type'       => 'colorpicker',
            'heading'    => esc_html__( 'Overlay Background color on the video','overcome'),
...
class WPBakeryShortCode_ef5_video extends WPBakeryShortCode
{
    ...
    protected function overcome_ef5_video_poster2($atts, $args = []){
        extract($atts);
        $args = wp_parse_args($args,[
            'class' => 'ef5-rounded-10'
        ]);
        $img_class = ['video-poster', 'video-poster2', $poster_style, $args['class']];
        overcome_image_by_size([
            'id'    => $poster2,
            'size'  => $poster_size,
            'class' => trim(implode(' ', $img_class))
    ...
    protected function overcome_ef5_video_play_button($atts, $args=[])
    {
        ...
        $play_css_class = overcome_optimize_css_class(implode(' ', $play_css_class));
    ...
    protected function overcome_ef5_video_popup($atts, $args=[]){
        ...
        switch ($layout_template) {
            case '1':
                $ef5_waves = overcome_html_animation(['anim' => $args['anim'], 'size' => '2']);
                break;
    ...
    protected function overcome_ef5_video_plain($atts, $args = []){
        global $wp_embed;
        extract($atts);
        ...
        switch ($video_source) {
            case '1':
                ...
                $video_h = $video_w / 1.61; //1.61 golden ratio
                if ( is_object( $wp_embed ) ) {
                    echo overcome_html( $wp_embed->run_shortcode( '[embed width="'.$video_w.'" height="'.$video_h.'"]' . $online_video . '[/embed]' ) );
                }
                break;
    ...
    protected function overcome_ef5_video_link($atts, $args = []){
        extract($atts);
        $args = wp_parse_args($args, []);
        /* parse button link */
        $use_link = false;
