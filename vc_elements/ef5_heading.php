...
class WPBakeryShortCode_ef5_heading extends WPBakeryShortCode
{
    ...
    protected function ef5_heading_main_heading_style($atts, $args = []){
        switch ($atts['layout_template']) {
            case '6':
                $text_size = ef5systems_vc_text_style_css($atts, ['default' => ['size' => '36 text-lg-48', 'color' => 'text_color_opts']]);
                break;
            case '5':
                $text_size = ef5systems_vc_text_style_css($atts, ['default' => ['size' => '45', 'color' => 'text_color_opts']]);
                break;
            case '4':
                $text_size = ef5systems_vc_text_style_css($atts, ['default' => ['size' => '45', 'color' => 'text_color_opts']]);
                break;
            case '3':
                $text_size = ef5systems_vc_text_style_css($atts, ['default' => ['size' => '48', 'color' => 'text_color_opts']]);
                break;
            default:
                $text_size = ef5systems_vc_text_style_css($atts, ['default' => ['size' => '36', 'color' => 'text_color_opts']]);
                break;
        }
        return $text_size;
    }
