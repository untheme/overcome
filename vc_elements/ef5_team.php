        ...
        array(
            ...
            array(
                ...
                'value' =>  array(
                    ...
                    '2' => get_template_directory_uri().'/vc_elements/layouts/team2.png',
                ),
                'std' => '1',
                'admin_label' => true
            ),
...
class WPBakeryShortCode_ef5_team extends WPBakeryShortCode
{
    ...
    protected function overcome_team_wrap_class($atts, $args =[]){
        extract($atts);
        ...
        switch ($layout_style) {
            ...
            default:
                $css_classes[] = 'ef5-grid row justify-content-center';
                break;
        }
