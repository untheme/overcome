...
class WPBakeryShortCode_ef5_posts extends WPBakeryShortCode
{
    ...
    protected function overcome_posts_item($atts, $args = []){
        ...
        $after = '<div class="overlay ef5-bg-overlay d-block opacity-1"><div class=""overlay-inner center-align><a href="'.get_the_permalink().'"><span class="fa fa-link"></span></a></div></div>'
        ?>
