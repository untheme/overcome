...
if(empty($atts['content_align']) && $atts['layout_template'] !== '2') $ttmn_wrap_classes[] = 'text-center';
?>
                            ...
                            echo '<div class="'.trim(implode(' ', $inner_css_classes)).'" '.$owl_item_space.'>';
                            	switch ($layout_template) {
                                    case '3':
                                        ...
                                        // position
                                        $x = echo $atts['text_color'];
                                        $this->overcome_tm_position($testimonial,['class' => 'text-12 text-uppercase d-block text-'. $x]);
                                        // star rating
