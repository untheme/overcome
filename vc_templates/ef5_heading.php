	...
	<?php 
		switch ($layout_template) {
			case '5':
				...
				$this->ef5_heading_main_heading($atts,['class' => 'text-45 font-style-600 ef5-heading text-white']);
			...
			case '4':
				...
				$this->ef5_heading_main_heading($atts,['class'=>'text-45 font-style-400']);
			...
			default:
				...
				$this->ef5_heading_main_heading_icon($atts);
				$this->ef5_heading_main_heading($atts,['class' => 'ef5-heading text-36 font-style-700']);
