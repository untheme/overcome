	...
	<?php 
		switch ($layout_template) {
			default:
				...
				$this->ef5_heading_main_heading($atts,['class' => 'text-48 font-style-700 ef5-heading ef5-text-white']);
				$this->ef5_heading_sub_heading($atts, ['class' => 'text-22 ef5-text-white']);
