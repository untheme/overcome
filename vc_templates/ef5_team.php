                        ...
                        <div class="ef5-item" <?php echo overcome_html($owl_item_space);?>>
                            <div class="<?php $this->overcome_team_item_inner_class($atts,['class' => 'overlay-wrap']);?>">
                                <?php switch ($layout_template) {
                                    case '2':
                                ?>
                                <div class="ef5-hover-shadow-4 transition ef5-rounded-10 p-30 pl-lg-45 pr-lg-45 pt-lg-53 pb-lg-45">
                                ...
                                ?>
                                    <div class="relative d-inline-block">
                                        ...
                                        ?>
                                        <div class="overlay ef5-bg-overlay-03 ef5-rounded-10 ef5-hover-shadow-3 d-flex justify-content-center"><div class="col-auto align-self-end"><?php
