        ...
        <?php
            switch ($layout_template) {
                ...
                if(get_post_type() === 'ef5_donation')
                    $overlay = class_exists('EF5Payments') ? ef5payments_donation_donate_button(['echo' => false,'class'=>'accent outline']) : overcome_post_read_more(['show_readmore' => '1','echo' => false]);
                else 
        	...
        	<div class="<?php echo trim(implode(' ', $item_css_class)); ?> ef5-hover-shadow-1 hoverdir-wrap fade-in">
                <?php 
                    overcome_post_media([
                        ...
                        'default_thumb'  => true,
                        'after'          => '<div class="overlay"><div class="overlay-inner">'.$overlay.'</div></div>'
                    ]);
                ?>
