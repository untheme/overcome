...
<div class="ef5-posts" id="<?php echo esc_attr($el_id);?>">
    ...
    <div class="<?php $this->ef5_posts_masonry_wrap_class($atts);?>" data-originleft="<?php echo overcome_html($originLeft);?>" data-layoutmode="<?php echo overcome_html($layoutmode); ?>">
