...
class UnBreak_CSS_Generator
{
    ...
    */
    ...
    {
        $this->opt_name = unbreak_get_theme_opt_name();
    ...
    function init()
    {
        ...
        $this->dev_mode = unbreak_get_theme_opt('dev_mode', false);
    ...
    protected function options_output()
    {
        ...
        printf('$invalid_color:%s;',unbreak_configs('invalid_color'));
        printf('$color_red:%s;',unbreak_configs('color_red'));
        printf('$color_green:%s;',unbreak_configs('color_green'));
        printf('$white:%s;',unbreak_configs('white'));
        
        // Theme Color 
        printf('$ef5-colors:(%s);',unbreak_colors_option_for_scss());

        // Typography 
        printf( '$BodyBG: %s;', unbreak_configs('body_bg'));
        printf( '$BodyFont: %s;', unbreak_configs('body_font'));
        printf( '$BodyFontSize: %s;', unbreak_configs('body_font_size'));
        printf( '$BodyLineHeight: %s;',unbreak_configs('body_line_height'));
        printf( '$BodyFontSizeL: %s;', unbreak_configs('body_font_size_large'));
        printf( '$BodyFontSizeM: %s;', unbreak_configs('body_font_size_medium'));
        printf( '$BodyFontSizeS: %s;', unbreak_configs('body_font_size_small'));
        printf( '$BodyFontSizeXS: %s;', unbreak_configs('body_font_size_xsmall'));
        printf( '$BodyFontSizeXXS: %s;', unbreak_configs('body_font_size_xxsmall'));
        printf( '$BodyColor: %s;', unbreak_configs('body_font_color'));
        printf( '$H1Size: %s;', unbreak_configs('h1_size'));
        printf( '$H2Size: %s;', unbreak_configs('h2_size'));
        printf( '$H3Size: %s;', unbreak_configs('h3_size'));
        printf( '$H4Size: %s;', unbreak_configs('h4_size'));
        printf( '$H5Size: %s;', unbreak_configs('h5_size'));
        printf( '$H6Size: %s;', unbreak_configs('h6_size'));
        printf( '$HeadingFont: %s;', unbreak_configs('heading_font'));
        printf( '$HeadingColor: %s;', unbreak_configs('heading_color'));
        printf( '$HeadingColorHover: %s;', unbreak_configs('heading_color_hover'));
        printf( '$HeadingFontW: %s;', unbreak_configs('heading_font_weight'));
        printf( '$MetaFont : %s;', unbreak_configs('meta_font'));
        printf( '$MetaColor: %s;', unbreak_configs('meta_color'));
        printf( '$MetaColorHover: %s;', unbreak_configs('meta_color_hover'));
        // Border
        printf( '$MainBorder: %s;', unbreak_configs('main_border'));
        printf( '$MainBorder2: %s;', unbreak_configs('main_border2'));
        printf( '$MainBorderColor: %s;', unbreak_configs('main_border_color'));
        // Comments
        printf( '$cmt_avatar_size: %s;', unbreak_configs('cmt_avatar_size'));
        printf( '$cmt_border: %s;', unbreak_configs('cmt_border'));
        /* Main Menu Height */
        printf('$main_menu_height:%s;', 'var(--main-menu-height)');
        
        /* Header side width */
        $header_sidewidth = unbreak_get_theme_opt('header_sidewidth',['width' => apply_filters('unbreak_header_sidewidth',unbreak_configs('header_sidewidth'))]);
        printf('$header_sidewidth: %s;', esc_attr($header_sidewidth['width']));

        /* Default Header Color */
        $header_link_color = unbreak_get_theme_opt('header_link_colors',apply_filters('unbreak_header_link_color', ['regular' => $primary_color, 'hover' => $accent_color, 'active' => $accent_color]) );
        ...
        /* Ontop Header Color */
        $ontop_link_color = unbreak_get_theme_opt('ontop_link_colors', apply_filters('unbreak_ontop_link_color', ['regular' => '#FFFFFF', 'hover' => $accent_color, 'active' => $accent_color]) );
        ...
        /* Sticky Header Color */
        $sticky_link_color = unbreak_get_theme_opt('sticky_link_colors',apply_filters('unbreak_sticky_link_color',['regular' => '#FFFFFF', 'hover' => $accent_color, 'active' => $accent_color]));
        ...
        /* Dropdown && Mobile */
        $dropdown_bg_opt = unbreak_get_theme_opt('dropdown_bg',['rgba' => apply_filters('unbreak_dropdown_bg', unbreak_configs('dropdown_bg'))]);
        printf('$dropdown_bg: %s;', esc_attr($dropdown_bg_opt['rgba']));
        $dropdown_link_colors = unbreak_get_theme_opt('dropdown_link_colors', apply_filters('unbreak_dropdown_link_colors',['regular' => unbreak_configs('dropdown_regular'), 'hover' => unbreak_configs('dropdown_hover'), 'active' => unbreak_configs('dropdown_active')]) );
        ...
        /* WooCommerce */
        printf( '$unbreak_product_single_image_w: %s;', unbreak_configs('unbreak_product_single_image_w') );
        printf( '$unbreak_product_single_image_h: %s;', unbreak_configs('unbreak_product_single_image_h') );
        
        printf( '$unbreak_product_loop_image_w: %s;', unbreak_configs('unbreak_product_loop_image_w') );
        printf( '$unbreak_product_loop_image_h: %s;', unbreak_configs('unbreak_product_loop_image_h') );

        printf( '$unbreak_product_gallery_thumbnail_w: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_w') );
        printf( '$unbreak_product_gallery_thumbnail_h: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_h') );

        printf( '$unbreak_product_gallery_thumbnail_v_w: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_v_w') );
        printf( '$unbreak_product_gallery_thumbnail_v_h: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_v_h') );

        printf( '$unbreak_product_gallery_thumbnail_h_w: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_h_w') );
        printf( '$unbreak_product_gallery_thumbnail_h_h: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_h_h') );

        printf( '$unbreak_product_gallery_thumbnail_space: %s;', unbreak_configs('unbreak_product_gallery_thumbnail_space') );
    ...
    function enqueue()
    {
        ...
        if ( $css )
        {
            wp_add_inline_style( 'unbreak', $css );
        }
    }
    ...
    {
        ob_start();
        $primary_color = unbreak_get_theme_opt( 'primary_color', apply_filters('unbreak_primary_color', unbreak_configs('primary_color')) );
        $accent_color  = unbreak_get_theme_opt( 'accent_color', apply_filters('unbreak_accent_color', unbreak_configs('accent_color')) );
        $secondary_color  = unbreak_get_theme_opt( 'secondary_color', apply_filters('unbreak_secondary_color', unbreak_configs('secondary_color')) );
        ...
        //--------------------------------------------------
        $header_link_colors = unbreak_get_page_opt( 'header_link_colors', ['regular' => '', 'hover' => '', 'active' => ''] );
        // menu regular
        ...
        // OnTop Menu
        $ontop_link_colors = unbreak_get_page_opt( 'ontop_link_colors', ['regular' => '', 'hover' => '', 'active' => ''] );
        // menu regular
         ...
         *
        */
        $header_sidewidth = unbreak_get_theme_opt('header_sidewidth', ['width' => ''] );
        $header_sidewidth_page = unbreak_get_page_opt('header_sidewidth', ['width' => ''] );
        ...
        if('' !== $header_sidewidth['width'] && 'px' !== $header_sidewidth['width']){
            echo '@media (min-width: 1200px){';
                printf(
                    ...
                    }', unbreak_align(), esc_attr($header_sidewidth['width'])
                );
         ...
         * Site Bordered
        */
        $site_layout = unbreak_get_opts('site_layout', '');
        $site_bordered = unbreak_get_opts('site_bordered_w',['padding-top'=>'30px','padding-right'=>'30px','padding-bottom'=>'30px','padding-left'=>'30px','units'=>'px']);
