 ...
 * @since 1.0.0 
*/
if(!function_exists('unbreak_header_contact_plain_text')){
	function unbreak_header_contact_plain_text($args = []){
		...
		$header_contact_plain = unbreak_get_opts('header_contact_plain', '0');
		if($header_contact_plain !== '1') return;

		$header_contact_plain_icon1 = unbreak_get_opts('header_contact_plain_icon1', '');
		$header_contact_plain_icon2 = unbreak_get_opts('header_contact_plain_icon2', '');
		$header_contact_plain_icon3 = unbreak_get_opts('header_contact_plain_icon3', '');

		$header_contact_plain_text1 = unbreak_get_opts('header_contact_plain_text1', '');
		$header_contact_plain_sub_text1 = unbreak_get_opts('header_contact_plain_sub_text1', '');
		$header_contact_plain_text2 = unbreak_get_opts('header_contact_plain_text2', '');
		$header_contact_plain_sub_text2 = unbreak_get_opts('header_contact_plain_sub_text2', '');
		$header_contact_plain_text3 = unbreak_get_opts('header_contact_plain_text3', '');
		$header_contact_plain_sub_text3 = unbreak_get_opts('header_contact_plain_sub_text3', '');

		$header_contact_plain_subtext1 = unbreak_get_opts('header_contact_plain_subtext1', '');
		$header_contact_plain_sub_subtext1 = unbreak_get_opts('header_contact_plain_sub_subtext1', '');
		$header_contact_plain_subtext2 = unbreak_get_opts('header_contact_plain_subtext2', '');
		$header_contact_plain_sub_subtext2 = unbreak_get_opts('header_contact_plain_sub_subtext2', '');
		$header_contact_plain_subtext3 = unbreak_get_opts('header_contact_plain_subtext3', '');
		$header_contact_plain_sub_subtext3 = unbreak_get_opts('header_contact_plain_sub_subtext3', '');
...
function unbreak_header_contact_plain_icon($args = []){
	$args = wp_parse_args($args, [
		'before' => '',
		'after'  => '',
		'icon'	 => 'flaticon-telephone'
	]);
	$show_contact = unbreak_get_opts('header_contact_plain', '0');
...
add_action('wp_footer','unbreak_header_contact_plain_popup_html');